$(function() {
    ...
    BGImageController = (function() {
        ...
        fadeBG = function(dir) {
            return $.Deferred(function(dfd) { (dir) ? $bf_background.fadeIn(1000, dfd.resolve) : $bf_background.fadeOut(1500, dfd.resolve)
            }).promise()
        },
    ...
    BGSlider = (function() {
        ...
        light = function(speed, val, hide) {
            $bf_overlay.stop().fadeTo(speed, val,
            function() {
        ...
        initEventsHandler = function() {
            ...
            $bf_items.children('img').bind('click',
            function() {
        ...
        navigate = function(dir) {
            ...
            animated = true;
            $bf_item_current = $bf_items.eq(current); (dir) ? ++current: --current;
        ...
        replaceBGImage = function(image) {
            ...
            $bg_image.stop().fadeOut(animSpeed * 2,
            function() {
                $(this).remove();
    ...
    Template = (function() {
        ...
        initEventsHandler = function() {
            ...
            $bf_background.delegate('img', 'click',
            function(e) {
        ...
        togglePageMenu = function(dir) { (dir) ? $bf_page_menu.stop().animate({
                left: '0px'
            },
